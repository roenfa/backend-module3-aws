...
import org.example.builders.querybuilder.QueryBuilder;
...
public class TransactionRepository implements ITransactionRepository {
  ...
  @Override
  public Collection<Transaction> getTransaction(String id) {
    String params = "id=" + id;
  ...
  private String generatePayload(String params){
    ...
    this.queryBuilder.select(columnsString);
    this.queryBuilder.from("transactionsupdate");
    this.queryBuilder.where(queryConstraint);
    queryObject.put("query", this.queryBuilder.getQuery());
